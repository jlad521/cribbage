...
//    init_pair(6, COLOR_GREEN, COLOR_BLACK); // for banner display
	...
	for (;;) {
        ...
        suit = 1;
        number = 12;
        gameDisplay.displayCard(xPos,yPos,suit,number, A_BOLD);
        gameDisplay.displayCard(xPos+5,yPos,suit,number, A_BOLD);
        gameDisplay.displayCard(xPos +10,yPos,suit,number, A_BOLD);
        gameDisplay.displayCard(xPos +15,yPos,suit,number, A_BOLD);
        /*
		if (key == -1) {
